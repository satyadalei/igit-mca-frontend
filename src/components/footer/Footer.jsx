      ...
      <div className={styles.footer_section}>
        ...
        {/* 1st div */}
          <div className={`${styles.footer_item} ${styles.footer_item1} `} >
            ...
            <p>
              Welcome to IGIT MCA Batch Page. This page
              is designed in view of
              junior for interacting with seniors. They can also view various resources inlcuding notes & wifi passwords.
            </p>
          </div>
          ...
          <div className={`${styles.footer_item} ${styles.footer_item2} `} >
            ...
            <div className={styles.dual_links_box}  >
                 ...
                 <ul>
                    ...
                    <li><Link href={"/coordinators"} >Coordinators</Link></li>
                    <li><Link href={"/blogs"} className={styles.disabled_link_text} onClick={disableLink} >Blogs</Link></li>
                    <li><Link className={styles.disabled_link_text} href={"/docs"}  onClick={disableLink}>Docs</Link></li>
                 </ul>
            </div>
          </div>
          {/* 2nd div complete */}
          ...
          <div className={`${styles.footer_item} ${styles.footer_item3} `} >
             ...
             <ul>
                ...
                <li><Link target='_blank' href={"https://igit.icrp.in/academic/"} >IGIT payment portal <OpenInNewIcon className={styles.font_size_inherit} /> </Link></li>
          ...
          <div className={`${styles.footer_item} ${styles.footer_item4} `} >
             ...
             <ul>
                <li> <p>+91-8144XXXXXX</p> </li>
                <li> <p>igitmca@41gmail.com</p> </li>
                <li style={{marginTop:"1rem"}} > 
                <p className={styles.technical_issue_text} >
                   For any technical issues contact <span >satyaprofessional99@gmail.com</span> 
                </p> 
                </li>
             </ul>
          </div>
